...
plugins:
	...
	standard_plugin_list=(simple-cloudflare-turnstile wp-statistics all-in-one-seo-pack featured-image-with-url)
	...
	# githuber-md
	download_and_move https://github.com/terrylinooo/githuber-md/archive/refs/tags/1.16.2.zip githuber-md
